...
import com.github.klee0kai.test_kotlin.di.interface_delegates.InterfaceDelegatesComponentStoneComponent
...
class InterfaceDelegatesTest {
    ...
    fun provideKeyboardTest() {
        //Given
        val DI = InterfaceDelegatesComponentStoneComponent()
