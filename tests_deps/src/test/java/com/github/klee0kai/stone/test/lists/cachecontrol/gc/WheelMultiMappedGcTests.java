...
public class WheelMultiMappedGcTests {
    ...
    public void createWorkCorrect() {
        ...
        //When
        WeakReference<Wheel> wheelFactory = DI.wheelMultiMappedModule().wheelFactory("1", 1);
        WeakReference<Wheel> wheelWeak = DI.wheelMultiMappedModule().wheelWeak("1", 1);
        WeakReference<Wheel> wheelSoft = DI.wheelMultiMappedModule().wheelSoft("1", 1);
        WeakReference<Wheel> wheelStrong = DI.wheelMultiMappedModule().wheelStrong("1", 1);
