...
class PlanetRollingTests {
    ...
    fun gcAllTest() {
        ...
        val earthStrong = WeakRef(Earth())
        val earthSoft = WeakRef(Earth())
        val planetWeak = WeakRef(Earth())
        val sunStrong = WeakRef(Sun())
        val sunSoft = WeakRef(Sun())
        val starWeak = WeakRef(Sun())
