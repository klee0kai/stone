...
class WindowMappedPartialGcTests {
    ...
    fun holdInListTest() {
        ...
        val holder2 = DI.windowsMappedModule()!!.windowStrong("2").get()!![0]
    ...
    fun partialRecreateList1Test() {
        ...
        val holder1 = DI.windowsMappedModule()!!.windowStrong("1").get()!![0]
        val holder2 = DI.windowsMappedModule()!!.windowStrong("2").get()!![1]
        val holder3 = DI.windowsMappedModule()!!.windowStrong("3").get()!![2]


        //When
        DI.gcAll()
        val uids1Reused = DI.windowsMappedModule()!!.windowStrong("1").get()!!.map { it.uuid }
        val uids2Reused = DI.windowsMappedModule()!!.windowStrong("2").get()!!.map { it.uuid }
        val uids3Reused = DI.windowsMappedModule()!!.windowStrong("3").get()!!.map { it.uuid }
