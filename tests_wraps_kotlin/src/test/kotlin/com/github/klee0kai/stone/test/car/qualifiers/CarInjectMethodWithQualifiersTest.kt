...
class CarInjectMethodWithQualifiersTest {
    @Test
    fun namedEmptyProvideTest() {
        ...
        //When
        DI.inject(carInject)
        val car = carInject.methodCarNamedEmpty
    ...
    fun namedAProvideTest() {
        ...
        //When
        DI.inject(carInject)
        val car = carInject.methodCarNamedA
    ...
    fun carMyQualifierProvideTest() {
        ...
        //When
        DI.inject(carInject)
        val car = carInject.methodCarMyQualifier
    ...
    fun carMyQualifierStringProvideTest() {
        ...
        //When
        DI.inject(carInject)
        val car = carInject.methodCarMyQualifierString
    ...
    fun carMyQualifierStringAProvideTest() {
        ...
        //When
        DI.inject(carInject)
        val car = carInject.methodCarMyQualifierA
    ...
    fun carMyQualifierStringBProvideTest() {
        ...
        //When
        DI.inject(carInject)
        val car = carInject.methodCarMyQualifierB
    ...
    fun carMyQualifierMultiProvideTest() {
        ...
        //When
        DI.inject(carInject)
        val car = carInject.methodCarMyQualifierMulti
    ...
    fun carMyQualifierMultiA1ProvideTest() {
        ...
        //When
        DI.inject(carInject)
        val car = carInject.methodCarMyQualifierMultiA1
    ...
    fun carMyQualifierMultiA2ProvideTest() {
        ...
        //When
        DI.inject(carInject)
        val car = carInject.methodCarMyQualifierMultiA2
    ...
    fun carMyQualifierMultiA2HardProvideTest() {
        ...
        //When
        DI.inject(carInject)
        val car = carInject.methodCarMyQualifierMultiA2Hard
    ...
    fun allCarsProvideTest() {
        ...
        assertEquals(
            1,
            carInject.methodAllCars!!.count { it.qualifier == "my_qualifier_a" }
        )
        assertEquals(
            1,
            carInject.methodAllCars!!.count { it.qualifier == "qualifier_multi_a2" }
        )
        assertEquals(
            1,
            carInject.methodAllCars!!.count { it.qualifier == "qualifier_multi_a2_hard" }
        )
    }
    ...
    fun provideCarsNamedEmptyTest() {
        ...
        assertEquals("named_empty", carInject.methodCarsNamedEmpty!![0].qualifier)
    }
    ...
    fun carsMyQualifierMultiA2HardTest() {
        ...
        assertEquals("qualifier_multi_a2_hard", carInject.methodCarsMyQualifierMultiA2Hard!![0].qualifier)
    }
}
