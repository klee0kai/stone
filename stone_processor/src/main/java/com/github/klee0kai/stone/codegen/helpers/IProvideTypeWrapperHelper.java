...
public interface IProvideTypeWrapperHelper {
    ...
    static IProvideTypeWrapperHelper findHelper(TypeName fieldType) {
        if (fieldType instanceof ParameterizedTypeName) {
            ...
            if (!typeName.typeArguments.isEmpty()) {
                if (Objects.equals(ClassName.get(WeakReference.class), typeName.rawType)
                    ...
                    return new RefFieldWrapperHelper(typeName.rawType, typeName.typeArguments.get(0));
                }
                ...
                if (Objects.equals(phantomProvide, typeName.rawType)
                    ...
                    return new ProvideFieldWrapperHelper(phantomProvide, typeName.typeArguments.get(0), true);

                if (Objects.equals(ClassName.get(LazyProvide.class), typeName.rawType)) {
                    return new ProvideFieldWrapperHelper(typeName.rawType, typeName.typeArguments.get(0), false);
                }
            }
        }
